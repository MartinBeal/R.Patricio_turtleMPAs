...
saveRDS(KDE,  paste0("data/analysis/UDs/individual_UDs_h", h, "_c",  cres, "_", period, ".rds"))
saveRDS(UD50, paste0("data/analysis/UDs/individual_UD50_h", h, "_c",  cres, "_", period, ".rds"))
saveRDS(UD95, paste0("data/analysis/UDs/individual_UD95_h", h, "_c",  cres, "_", period, ".rds"))
...
## Save ## --------------------------------------------------------------
saveRDS(KDEcmbnd_w, paste0("data/analysis/UDs/w_groupUD_h", h, "_c",  cres, "_", period, ".rds"))
saveRDS(KDEcmbnd_a, paste0("data/analysis/UDs/a_groupUD_h", h, "_c",  cres, "_", period, ".rds"))
...
## Save ## --------------------------------------------------------------------
# saveRDS(percUDs, paste0("data/analysis/UDs/w_groupCDFs_h", h, "_c",  cres, "_", period, ".rds"))
# saveRDS(percUDs, paste0("data/analysis/UDs/a_groupCDFs_h", h, "_c",  cres, "_", period, ".rds"))
